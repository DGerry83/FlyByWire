...
### Proposed Structure
[Derive from the taxonomy in CORE_PROTOCOLS.md §1 — `active\`, `finished\`, `archive\YYYY-MM\`, `knowledge\`, `indices\` — listing this repository's actual sessions and any retained root files such as CORE_PROTOCOLS.md, GATES.md, MASTER_PLAN.md]
