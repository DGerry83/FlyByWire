...
- v3 native-interop & hot-path checklist (2026-09-03): `reference\08-native-interop.md` added (process-global state, hot-path allocation, resource-acquisition symmetry) and wired in via `CORE_PROTOCOLS.md` §5.9, `reference\01-core-principles.md` §10, and the `CHUNK_N_CONTRACT.md` Constraints section; `DESIGN_SPEC.md` §3.2 extended to record intentional partial coverage as known limitations. Origin: external review of a v2-driven project (DearImGui-KSP); plan in `notes\V3_PLAN.md`.
