...
- [Explicitly excluded thing]
- [Known limitation — intentional *partial* coverage of an in-scope feature: what is covered, what is not, and why (e.g. "Ctrl modifier fed to the UI; Shift/Alt selection shortcuts not supported in MVP"). Anything a consumer could otherwise mistake for an oversight belongs here.]
