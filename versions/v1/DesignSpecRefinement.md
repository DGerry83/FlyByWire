...
After all questions are answered, write the complete `DESIGN_SPEC.md` using the template below. Populate every section. If a section does not apply, write "Not applicable" followed by a one-sentence explanation.
