...
> **Archived snapshot (v2).** Kept for reference and as an eval baseline — see `eval/TESTING.md` at the repo root. The current skill is `versions/v3`; install that one.
